...
?>
  ...
  <form method="POST" action="auth/teacherreg.php" enctype="multipart/form-data" >
    <img class="mb-4" src="images/logo.png" alt="" width="100" height="57">
    <h1 class="h3 mb-3 fw-normal">Do Registration As A Teacher</h1>
...
printf("<p class='text-danger'>  %s   </p>", $_SESSION['nameerror'] );
}
?>
...
printf("<p class='text-danger'>  %s   </p>", $_SESSION['roleerror'] );
}
?>
    </div>
...
?>
    ...
    <button class="w-100 btn btn-lg btn-primary my-3" type="submit"  name="submit" >Sign in</button>
